	<?php
	$sql_moinhat="select * from sanpham order by idsanpham desc limit 0,3";
...
?>
	<div class="tieude">Sản phẩm mới nhất</div>
					...
					?>
                    	<li><a href="?quanly=chitietsp&idloaisp=<?php echo $sp_moinhat['loaisp'] ?>&id=<?php echo $sp_moinhat['idsanpham'] ?>">
                        	<img src="admincp/modules/quanlysanpham/uploads/<?php echo $sp_moinhat['hinhanh'] ?>" width="150" height="150" />
                            <p style="color:skyblue"><?php echo $sp_moinhat['tensp'] ?></p>
